...
function ReservationDashboard() {
  ...
  // New function to handle View Billing button click
  const handleViewBilling = () => {
    navigate('/billing');  // ඔයාට අවශ්‍යනම් reservation id වගේ parameter එක්කරන්න පුළුවන්
  };
  ...
  return (
    <div className="reservation-container">
      ...
      {/* Add the View Billing button here */}
      <button onClick={handleViewBilling} className="billing-button" style={{ marginTop: '20px' }}>
        View Billing
      </button>
